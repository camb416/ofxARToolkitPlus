...
void testApp::setup(){
	...
	//artk.setup(width, height);
     artk.setup(width,height,"LogitechPro4000.dat","cameron.cfg");
    // artk.setup(width,height,"LogitechPro4000.dat","markerboard_480-499.cfg");
    //artk.setup(width, height, "LogitechPro4000.dat", "marker64.pat");
...
#ifdef CAMERA_CONNECTED
        curFrame.update();
		colorImage.setFromPixels(curFrame.getPixels(), width,height);
        //grayImage.setFromPixels(vidGrabber.getPixels(), width, height);
